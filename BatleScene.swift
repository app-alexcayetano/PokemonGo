...
class BattleScene: SKScene, SKPhysicsContactDelegate {
    ...
    let pokemonPixelsPerSecond = 100.0
    ...
    override func didMove(to view: SKView) {
        ...
        let bgImage = SKSpriteNode(imageNamed: "fondobattle")
        ...
        message.size = CGSize(width: 159, height: 150)
    ...
    func setupPokemon(){
        ...
        let moveRight = SKAction.moveBy(x: CGFloat(self.pokemonDistance), y: 0, duration: self.pokemonDistance/pokemonPixelsPerSecond)
